      ...
      <div className="mx-auto max-w-7xl">
              ...
              return (
                ...
                >
                  <div className="flex h-10 w-10 items-center justify-center overflow-hidden rounded-full border border-emerald-400/30 bg-white">
                    <img src={p.logo} alt={p.name} className="h-[118%] w-[118%] scale-[1.38] object-contain" />
                  </div>
        ...
        <div className="grid grid-cols-2 gap-8 border-t border-emerald-500/10 py-10 md:grid-cols-4">
          ...
          <div className="col-span-2 md:col-span-1">
            <div className="flex items-center gap-2.5">
              <div className="grid h-12 w-12 shrink-0 place-items-center overflow-hidden rounded-2xl border border-emerald-400/30 bg-white p-0.5 shadow-sm">
                <CrmsLogoImage className="h-[118%] w-[118%] scale-[1.38] object-contain" />
              </div>
              <div className="flex flex-col leading-none">
                <span className="text-sm font-black text-emerald-50">CRMS</span>
        ...
        <div className="flex flex-col items-center justify-between gap-3 border-t border-emerald-500/10 pt-6 text-[0.6875rem] text-emerald-500/50 md:flex-row">
          <p className="flex items-center gap-2">
            <span className="grid h-7 w-7 place-items-center overflow-hidden rounded-full bg-white p-0.5 shadow-sm">
              <CrmsLogoImage className="h-full w-full object-contain" alt="CRMS" />
            </span>
            © {new Date().getFullYear()} Community Resource Mapping System · San Policarpo, Eastern Samar
          </p>
